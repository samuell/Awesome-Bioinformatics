...
- **[SciPipe](https://github.com/scipipe/scipipe)** - Workflow library embedded in the Go programming language, with a focus on supporting complex workflow constructs, compiling the workflow to a single static binary, powerful file naming and providing audit reports for every output. [ [paper-2019](https://pubmed.ncbi.nlm.nih.gov/31029061/) | [web](https://scipipe.org) ]  
